...
class Day04Test {
    ...
    fun `part2 invalid passports`() {
       ...
       """.trimIndent()
        ...
        assertEquals(0, Day04().solvePart2(input))
    }

    @Test
    fun `part2 valid passports`() {
        val input = """
       ...
       """.trimIndent()
        ...
        assertEquals(4, Day04().solvePart2(input))
    }
    ...
    fun `part2 actual data`() {
        ...
        assertEquals(198, Day04().solvePart2(input))
    }
}